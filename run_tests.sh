...
if echo "$output" | grep -q "ALL DMA MODEL TESTS PASSED"; then
    echo "✓ PASSED"; PASS=$((PASS + 1))
else
    echo "✗ FAILED"; FAIL=$((FAIL + 1))
fi
...
echo "$output" | grep -E "(TEST|PASS|FAIL|>>>)" | tail -5
if echo "$output" | grep -q "ALL VPU TESTS PASSED"; then
    echo "✓ PASSED"; PASS=$((PASS + 1))
else
    echo "✗ FAILED"; FAIL=$((FAIL + 1))
fi
...
echo "$output" | grep -E "(TEST|PASS|FAIL|>>>)" | tail -5
if echo "$output" | grep -q "ALL LCP TESTS PASSED"; then
    echo "✓ PASSED"; PASS=$((PASS + 1))
else
    echo "✗ FAILED"; FAIL=$((FAIL + 1))
fi
...
echo "$output" | grep -E "(TEST|PASS|FAIL|>>>)" | tail -5
if echo "$output" | grep -q "ALL TPC INTEGRATED TESTS PASSED"; then
    echo "✓ PASSED"; PASS=$((PASS + 1))
else
    echo "✗ FAILED"; FAIL=$((FAIL + 1))
fi
