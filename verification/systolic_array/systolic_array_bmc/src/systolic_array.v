...
module systolic_array #(
    ...
    always @(posedge clk) begin
        if (state == S_COMPUTE)
            $display("[%0t] CHAIN cc=%0d aR30=%0d aR31=%0d aR32=%0d aR33=%0d",
                     $time, cycle_count,
                     $signed(pe_row[3].pe_col[0].pe_inst.act_reg),
                     $signed(pe_row[3].pe_col[1].pe_inst.act_reg),
                     $signed(pe_row[3].pe_col[2].pe_inst.act_reg),
                     $signed(pe_row[3].pe_col[3].pe_inst.act_reg));
    end
    `endif
